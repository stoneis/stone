 ...
 * @since 2013.09.03
 */
public class PageNavigatorStruts2 {
	...
	public String getPageNavigator(int totalCount, int listCount, int pagePerBlock,
		...
		if(totalCount > 0) {
			...
			if(pageNum > 1){
				sb.append("<a href=\"").append("boardListAction?pageNum=1&amp;searchType="+searchType+"&amp;searchText="+searchText);
				sb.append("\" title=\"<<\"><<</a>&nbsp;");
			}
			if (isPrev) {
				int goPrevPage = startPage - pagePerBlock;			
				sb.append("&nbsp;&nbsp;<a href=\"").append("boardListAction?pageNum="+goPrevPage+"&amp;searchType="+searchType+"&amp;searchText="+searchText);
				sb.append("\" title=\"<\"><</a>");
			} else {
			...
			for (int i = startPage; i <= endPage; i++) {
				if (i == pageNum) {
					...
					sb.append("<a href=\"").append("boardListAction?pageNum="+i+"&amp;searchType="+searchType+"&amp;searchText="+searchText);
			...
			if (isNext) {
				...
				sb.append("<a href=\"").append("boardListAction?pageNum="+goNextPage+"&amp;searchType="+searchType+"&amp;searchText="+searchText);
				sb.append("\" title=\">\">></a>");
			} else {
				
			}
			if(totalNumOfPage > pageNum){
				sb.append("&nbsp;&nbsp;<a href=\"").append("boardListAction?pageNum="+totalNumOfPage+"&amp;searchType="+searchType+"&amp;searchText="+searchText);
				sb.append("\" title=\">>\">>></a>");
			}
